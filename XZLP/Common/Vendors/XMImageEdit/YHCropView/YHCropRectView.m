...
//        imageView.image = [[UIImage imageNamed:@"caijian"] resizableImageWithCapInsets:UIEdgeInsetsMake(100.0f, 23.0f, 23.0f, 23.0f)];
        imageView.image = [UIImage imageNamed:@"caijian"];
